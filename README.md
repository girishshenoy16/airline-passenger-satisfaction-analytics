...
[![Plotly](https://img.shields.io/badge/Plotly.js-2.27-3F4F7F.svg?logo=plotly&logoColor=white)]()
[![pandas](https://img.shields.io/badge/pandas-Data%20Analysis-150458.svg?logo=pandas&logoColor=white)]()
[![SciPy](https://img.shields.io/badge/SciPy-Statistics-8CAAE6.svg?logo=scipy&logoColor=white)]()
...
![Executive Dashboard](docs/assets/overview.png)
...
### Executive Overview
![Executive Overview](docs/assets/overview.png)
*Real-time KPIs, satisfaction distribution, and executive decision summary*

---

### Demographic Analysis
![Demographic Analysis](docs/assets/demographics.png)
*Interactive heatmaps, cross-tabulations, and travel class rankings*

---

### Statistical Insights
![Statistical Insights](docs/assets/statistics.png)
...
```mermaid
graph TB
    subgraph "Analytics Pipeline (Python)"
        A[Raw CSV Dataset] --> B[Data Ingestion<br/>Schema Validation]
        B --> C[Data Validator<br/>Missing & Duplicates]
        C --> D[Feature Engineering<br/>Shares, Segments]
        D --> E[Statistical Engine<br/>Chi-Square, CI, MoE]
        E --> F[Cross-Tabulations<br/>Demographic Analysis]
        F --> G[Insights Engine<br/>Executive Recommendations]
        G --> H[Export JSON<br/>dashboard_metrics.json]
    end

    subgraph "Executive Dashboard (HTML5/CSS3/JS)"
        H --> I[DataManager<br/>JSON Loading & Filtering]
        I --> J[Charts Module<br/>Plotly.js Rendering]
        I --> K[App Module<br/>Navigation & Logic]
        J --> L[Executive Overview<br/>KPIs & Distribution]
        J --> M[Demographic Analysis<br/>Heatmaps & Rankings]
        J --> N[Statistical Insights<br/>Tests & Intervals]
    end
```
